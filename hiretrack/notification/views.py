...
from notification.serializers import RemainderSerializer, RemainderAsReadSerializer
from rest_framework.permissions import IsAuthenticated
from notification.models import Notification, Remainder
from notification.query import get_by_id, get_by_remainder_id
...
class ImmediateRemainderView(APIView):
    ...
    def post(self, request):
        try:
            serializer = RemainderSerializer(
