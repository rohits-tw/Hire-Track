...
class InterviewForUser(models.Model):
    ...
    interviewer_id = models.ForeignKey(CustomUser, on_delete = models.CASCADE, related_name = "interviewer_id" )
    interview_date = models.DateTimeField()
    interview_type = models.CharField(max_length=50, choices=INTERVIEW_TYPE, default="Screening Round")
